...
*/
#define FEEDER_DEFAULT_FULL_ADVANCED_ANGLE  120				      // [°]  usually 90 (type: uint8_t)
#define FEEDER_DEFAULT_HALF_ADVANCED_ANGLE  100              // [°]  exact math would be 43.85. may need tweaking. only needed if advancing half pitch (for 0401 smds) (type: uint8_t)
#define FEEDER_DEFAULT_RETRACT_ANGLE  75				      // [°]  usually 20, chose 15 to be failsafe (type: uint8_t)
#define FEEDER_DEFAULT_FEED_LENGTH 2			// [mm] distance to be fed if no feedlength was given in a feed command
...
#define FEEDER_DEFAULT_TYPE				1			// feeder type: 0 = 0816 servo style, 1 = bing v2 pulse
												// default to bing because servo type pulses and messes up bings
												// with bing default the output pin does nothing 
